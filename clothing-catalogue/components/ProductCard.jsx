    ...
    <div className="product-card-upgraded" style={{ backgroundColor: '#FFFFFF', display: 'flex', flexDirection: 'column', textAlign: 'left', position: 'relative', borderRadius: '8px', overflow: 'hidden', transition: 'transform 0.2s ease, box-shadow 0.2s ease', border: '1px solid #F1F5F9' }}>
      ...
      <div style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <div style={{ fontSize: '0.85rem', color: '#4B5563', display: 'flex', flexDirection: 'column', gap: '0.35rem', marginBottom: '1.25rem', flex: 1 }}>
          ...
          <span><strong style={{ color: 'var(--text-dark)' }}>MOQ:</strong> {moq || 'N/A'}</span>
        ...
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', backgroundColor: 'var(--accent-color)', color: '#FFF', padding: '0.6rem', borderRadius: '6px', textDecoration: 'none', fontWeight: 600, fontSize: '0.95rem', transition: 'background-color 0.2s', width: '100%', boxSizing: 'border-box' }}>
